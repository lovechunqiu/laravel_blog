                ...
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:delnavs('{{$v->nav_id}}');">删除</a>
                        </td>
                    </tr>
                    @endforeach
                </table>
...
<script>
    function changeOrder(obj, nav_id){
        ...
        $.post("{{url('admin/navs/changeorder')}}", {nav_id:nav_id,nav_order:nav_order,'_token':'{{csrf_token()}}'}, function(data){
            if(data.status == 0){
